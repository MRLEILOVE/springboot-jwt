...
import com.leigq.www.jwt.config.jackson.DateDeserializer;
import com.leigq.www.jwt.config.jackson.LocalDateTimeDeserializer;
...
public final class JacksonUtils {
     ...
     * @return the string
     */
    public static <T> String toJson(T obj, boolean isPretty) {
        try {
            if (isPretty) {
     ...
     */
    public static <T> T toGenericObj(String json, Class<?> collectionClass, Class<?>... elementClasses) {
        try {
...
//				.setSerializationInclusion(JsonInclude.Include.NON_NULL)
            ...
            // 反序列化配置,针对 Date 时间，使用自定义 DateDeserializer
